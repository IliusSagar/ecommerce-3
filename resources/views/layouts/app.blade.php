...
<div class="super_container">
	...
	<header class="header">
		...
		@php 
			$catgory = DB::table('categories')->get();
		@endphp
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://sassconnect.com" target="_blank">sassConnect</a>
